...
public class ProductoMenu {
    ...
    private void modificar() {
        ...
        if (!precioStr.isEmpty()) {
            ...
            if (precio == null || precio <= 0) { System.out.println("Precio inválido, no se modificó."); }
        ...
        if (!stockStr.isEmpty()) {
            ...
            if (stock == null || stock < 0) { System.out.println("Stock inválido, no se modificó."); }
    ...
    private void bajaLogica() {
        ...
        if (productoRepo.eliminarLogico(id)) {
            ...
            System.out.println("Error: no se encontró el producto o ya estaba dado de baja.");
        }
    }
